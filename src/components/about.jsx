...
const About = () => {
  return (
    <div className="relative w-full text-white text-center h-[500px] flex flex-col items-center content-center self-center">
      <img
        src={aboutBG}
      ...
      <div
        ...
        id="ini"
      >
        <h1 className="font-inter font-[800] text-[3rem] ">About Us</h1>
